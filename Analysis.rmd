...
AnalysisAdDetailList<-AnalysisAdDetailList[with(AnalysisAdDetailList, order(-xtfrm(AnalysisAdDetailList$MeretCleared))), ]
...
summary(AnalysisAdDetailList$MeretCleared)# JESUS


AnalysisAdDetailList[AnalysisAdDetailList$SiteID=="77293656","MeretCleared"]<-54
AnalysisAdDetailList[AnalysisAdDetailList$SiteID=="79203941","MeretCleared"]<-130
AnalysisAdDetailList[AnalysisAdDetailList$SiteID=="76934101","MeretCleared"]<-52
AnalysisAdDetailList[AnalysisAdDetailList$SiteID=="76945399","MeretCleared"]<-60

AnalysisAdDetailList[AnalysisAdDetailList$SiteID=="76945398","MeretCleared"]<-57
AnalysisAdDetailList[AnalysisAdDetailList$SiteID=="76945569","MeretCleared"]<-57
AnalysisAdDetailList[AnalysisAdDetailList$SiteID=="76945397","MeretCleared"]<-97
AnalysisAdDetailList[AnalysisAdDetailList$SiteID=="76945581","MeretCleared"]<-53
AnalysisAdDetailList[AnalysisAdDetailList$SiteID=="77391121","MeretCleared"]<-118
AnalysisAdDetailList[AnalysisAdDetailList$SiteID=="76981886","MeretCleared"]<-53
AnalysisAdDetailList[AnalysisAdDetailList$SiteID=="76945396","MeretCleared"]<-134
AnalysisAdDetailList[AnalysisAdDetailList$SiteID=="76913761","MeretCleared"]<-56
AnalysisAdDetailList[AnalysisAdDetailList$SiteID=="75347668","MeretCleared"]<-67
AnalysisAdDetailList[AnalysisAdDetailList$SiteID=="74168404","MeretCleared"]<-23
AnalysisAdDetailList[AnalysisAdDetailList$SiteID=="76981931","MeretCleared"]<-30
AnalysisAdDetailList[AnalysisAdDetailList$SiteID=="76981929","MeretCleared"]<-54
AnalysisAdDetailList[AnalysisAdDetailList$SiteID=="76981887","MeretCleared"]<-51
AnalysisAdDetailList[AnalysisAdDetailList$SiteID=="76981921","MeretCleared"]<-73
AnalysisAdDetailList[AnalysisAdDetailList$SiteID=="76981884","MeretCleared"]<-74
AnalysisAdDetailList[AnalysisAdDetailList$SiteID=="76981925","MeretCleared"]<-42
AnalysisAdDetailList[AnalysisAdDetailList$SiteID=="76981926","MeretCleared"]<-56
AnalysisAdDetailList[AnalysisAdDetailList$SiteID=="76981927","MeretCleared"]<-58
...
#Unfinished builds
patternUnCon<-".*várható átadás.*"

AnalysisAdDetailList[AnalysisAdDetailList$Allapot %in% c("Új","Új Építésű") & grepl(patternUnCon,AnalysisAdDetailList$RC_Description,ignore.case=T),"RC_Condition"]<-"Építés alatt"
...
References<-is.na(AnalysisAdDetailList$ReferenceNumber)
Noreference<-AnalysisAdDetailList[References,]
Reference<-AnalysisAdDetailList[!References,]
Reference<-Reference[!duplicated(Reference[c("ReferenceNumber")]),]

AnalysisAdDetailList<-rbind(Noreference,Reference)

flog.info("COMPLETED: crude_deduplication")
```
...
```{r Feature_engineering,purl=FALSE, eval=FALSE}
library(psych)
...
AnalysisAdDetailList2<-AnalysisAdDetailList2[!is.na(AnalysisAdDetailList2$Kerulet),]
skew(AnalysisAdDetailList2$RC_ArMil)
qqnorm(AnalysisAdDetailList2$RC_ArMil)
qqline(AnalysisAdDetailList2$RC_ArMil) #oh no
AnalysisAdDetailList2$RC_ArMil <- log(AnalysisAdDetailList2$RC_ArMil)
skew(AnalysisAdDetailList2$RC_ArMil)
qqnorm(AnalysisAdDetailList2$RC_ArMil)
qqline(AnalysisAdDetailList2$RC_ArMil)# much nicer:)
ggplot(data= AnalysisAdDetailList2, aes(x=RC_ArMil)) +
        geom_histogram() + labs(x='Price Historgram')

#sqmeter

#this plot gives us price-floorsize 
ggplot(data=AnalysisAdDetailList2[!is.na(AnalysisAdDetailList2$RC_ArMil),], aes(x=MeretCleared, y=RC_ArMil))+
        geom_point(col='blue') + geom_smooth(method = "lm", se=FALSE, color="black", aes(group=1)) +
        scale_y_continuous(breaks= seq(0, 800000, by=100000)) +
        geom_text_repel(aes(label = ifelse(AnalysisAdDetailList2$MeretCleared[!is.na(AnalysisAdDetailList2$RC_ArMil)]>4500, rownames(AnalysisAdDetailList2), ''))) #this is ridiculous
AnalysisAdDetailList2<-AnalysisAdDetailList2[AnalysisAdDetailList2$MeretCleared<=400 & AnalysisAdDetailList2$MeretCleared>=10,]
cor(AnalysisAdDetailList2$RC_ArMil, AnalysisAdDetailList2$MeretCleared, use= "pairwise.complete.obs")
flog.info("COMPLETED: Feature_engineering")
```
...
AnalysisAdDetailList2<-AnalysisAdDetailList2[,!(names(AnalysisAdDetailList2) %in% c("Helyseg","Meret","Ar","Deviance","Szobakszama", "Kategoria","PublishedTime","QueryState", "Havikozoskoltseg","Ingatlantipusa","Lift","Gepesitett","SzobaSzamCleared","Felszobakszama","SiteUrl","Riaszto","KulonWC","Tulajdonjogberletijog","Legkondicinalo","Belmagassag","Futestipusa","Allapot","Emelet","Butorozotte","Description","Ingatlanfelszereltsege","Hirdeto","Kertkapcsolatos","Latitude","Longitude"))]
flog.info("FINISHED: dropping_columns")
```


##PreProcessing predictor variables
###removing numeric skewedness
removing skewedness
```{r preprocessing, eval=FALSE,purl=FALSE}
sum(is.na(AnalysisAdDetailList2$MeretCleared))

if (abs(skew(AnalysisAdDetailList2$MeretCleared))>0.8){AnalysisAdDetailList2$MeretCleared <- log(AnalysisAdDetailList2$MeretCleared +1)}

PreNum<-preProcess(as.data.frame(AnalysisAdDetailList2$MeretCleared), method=c("center","scale"))
DFnorm <- predict(PreNum, as.data.frame(AnalysisAdDetailList2$MeretCleared))
dim(DFnorm)
...
```{r endocing, eval=FALSE,purl=FALSE}

categoricalvariables<-as.data.frame(AnalysisAdDetailList2[,c("RC_Condition","Kerulet")])
DFdummies <- as.data.frame(model.matrix(~.-1, categoricalvariables))
dim(DFdummies)

#check if some values are absent in the test set
ZerocolTest <- which(colSums(DFdummies[(nrow(AnalysisAdDetailList2[!is.na(AnalysisAdDetailList2$RC_ArMil),])+1):nrow(AnalysisAdDetailList2),])==0)
colnames(DFdummies[ZerocolTest])



#Also taking out variables with less than 10 ‘ones’ in the train set.
fewOnes <- which(colSums(DFdummies[1:nrow(AnalysisAdDetailList2[!is.na(AnalysisAdDetailList2$RC_ArMil),]),])<10)
...
#caret finds my parameters

xgb_caret <- train(x=combined, y=AnalysisAdDetailList2$RC_ArMil[!is.na(AnalysisAdDetailList2$RC_ArMil)], method='xgbTree', trControl= TRC_CV5, tuneGrid=xgb_grid)
#xgb_caret$bestTune
