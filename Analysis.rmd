...
drop_upload(paste(Shinyfolder,exportedShinyFile,sep="/"), path = NULL, mode = "overwrite", autorename = TRUE,
  mute = FALSE, verbose = FALSE, dtoken = token)


file.copy(SessionTableFile,Shinyfolder,overwrite = TRUE)
drop_upload(paste(Shinyfolder,SessionTableFile,sep="/"), path = NULL, mode = "overwrite", autorename = TRUE,
  mute = FALSE, verbose = FALSE, dtoken = token)


file.copy(AnalysisAdListFile,Shinyfolder,overwrite = TRUE)
drop_upload(paste(Shinyfolder,AnalysisAdListFile,sep="/"), path = NULL, mode = "overwrite", autorename = TRUE,
  mute = FALSE, verbose = FALSE, dtoken = token)
