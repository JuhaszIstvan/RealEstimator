...
exportedShiny<-AnalysisAdDetailList[,(names(AnalysisAdDetailList) %in% c("RC_ArMil","SiteID","QueryTime","RC_Title","Kerulet","MeretCleared","RC_Condition","RC_Heating","RC_Material"))]
