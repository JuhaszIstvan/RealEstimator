...
```{r DummyVars_BasicModels,purl=FALSE}
#KeruletOnly
...
testResults <- data.frame(TrainingSet$SiteID,TrainingSet$QueryTime,XFiltered,RC_ArMil = RC_ArMil, Linear_Regression = predict(LM_modelbasic, LM_Interact_Basic))
